...
![](https://upload-images.jianshu.io/upload_images/1433350-587f0fedaf502817.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
> ps 路径改成你自己的
- 例如
![添加你的磁盘路径](https://upload-images.jianshu.io/upload_images/1433350-9e6ce04524b631ba.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
- 4.打开webstorm 点击linstion server然后输入 
```html
http://jetbrains-license-server
```
![](https://upload-images.jianshu.io/upload_images/1433350-8486f5d72b66c950.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
- 5.点击`active` 激活成功
激活码 2020-01-10 更新 https://545c.com/file/18744103-416965138
- 6.如果激活不成功 把code放进去
```
